...
app.get('/api/peminjaman-alat',(req, res) => {
  ...
  app.post('/api/peminjaman-alat',(req, res) => {
    let data = {id_peminjaman_alat: req.body.id_peminjaman_alat, id_peminjam: req.body.id_peminjam, id_alat: req.body.id_alat, tanggal_pemakaian: req.body.tanggal_pemakaian, tanggal_selesai:req.body.tanggal_selesai, tanggal_kembali:req.body.tanggal_kembali};
...
app.get('/api/peminjamn/:id_peminjam',(req, res) => {
...
let sql = "UPDATE details peminjam SET id_peminjam='"+req.body.id_peminjam+"',nama_peminjam='"+req.body.nama_peminjam+"',jenis_kelamin='"+req.body.jenis_kelamin+"' WHERE id_peminjam ="+req.params.id_peminjam;
let query = conn.query(sql, (err, results) => {
  if(err) throw err;
  res.send(JSON.stringify({"status": 200, "error": null, "response": results,
  "links":[
...
app.delete('/api/peminjamann/:id_peminjam',(req, res) => {
